...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { average_rating: @professor.average_rating, department: @professor.department, name: @professor.name, school: @professor.school }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { average_rating: @professor.average_rating, department: @professor.department, name: @professor.name, school: @professor.school }
    assert_redirected_to professor_path(assigns(:professor))
  end
